...
def main(ctx):
  ...
  linux_cxx("g++-5 gnu-03,11,14,1z", "g++-5", packages="g++-5", buildtype="boost", image="cppalliance/droneubuntu1804:1", environment={'B2_TOOLSET': 'gcc', 'B2_COMPILER': 'g++-5', 'B2_CXXSTD': '03,11,14,1z', 'B2_CXXSTD_DIALECT': 'B2_CXXSTD-dialect=gnu', }, globalenv=globalenv),
  ...
  linux_cxx("g++-6 gnu++03,11,14,1z Job 9", "g++-6", packages="g++-6", buildtype="boost", image="cppalliance/droneubuntu1804:1", environment={'B2_TOOLSET': 'gcc', 'B2_COMPILER': 'g++-6', 'B2_CXXSTD': '03,11,14,1z', 'B2_CXXSTD_DIALECT': 'B2_CXXSTD-dialect=gnu', }, globalenv=globalenv),
  ...
  linux_cxx("g++-7 gnu++03,11,14,17", "g++-7", packages="g++-7", buildtype="boost", image="cppalliance/droneubuntu1804:1", environment={'B2_TOOLSET': 'gcc', 'B2_COMPILER': 'g++-7', 'B2_CXXSTD': '03,11,14,17', 'B2_CXXSTD_DIALECT': 'B2_CXXSTD-dialect=gnu', }, globalenv=globalenv),
  ...
  linux_cxx("g++-8 gnu++03,11,14,17", "g++-8", packages="g++-8", buildtype="boost", image="cppalliance/droneubuntu1804:1", environment={'B2_TOOLSET': 'gcc', 'B2_COMPILER': 'g++-8', 'B2_CXXSTD': '03,11,14,17', 'B2_CXXSTD_DIALECT': 'B2_CXXSTD-dialect=gnu', }, globalenv=globalenv),
  ...
  linux_cxx("g++-9 gnu++03,11,14,17", "g++-9", packages="g++-9", buildtype="boost", image="cppalliance/droneubuntu1804:1", environment={'B2_TOOLSET': 'gcc', 'B2_COMPILER': 'g++-9', 'B2_CXXSTD': '03,11,14,17,2a', 'B2_CXXSTD_DIALECT': 'B2_CXXSTD-dialect=gnu', }, globalenv=globalenv),
  ...
  linux_cxx("g++-10 gnu++03,11,14,17,20", "g++-10", packages="g++-10", image="cppalliance/droneubuntu2004:1", buildtype="boost", environment={'B2_TOOLSET': 'gcc', 'B2_COMPILER': 'g++-10', 'B2_CXXSTD': '03,11,14,17,20', 'B2_CXXSTD_DIALECT': 'B2_CXXSTD-dialect=gnu', }, globalenv=globalenv),
  ...
  linux_cxx("Ubuntu g++-13", packages="g++-13", buildtype="boost", image="cppalliance/droneubuntu2404:1", environment={'B2_TOOLSET': 'gcc', 'B2_COMPILER': 'g++-13', 'B2_CXXSTD': '14,17,20,23', }, globalenv=globalenv),
