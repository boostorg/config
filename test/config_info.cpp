...
void print_boost_macros()
{
   ...
   PRINT_MACRO(BOOST_NO_CXX20_CHAR8_T);
   ...
   PRINT_MACRO(BOOST_NO_CXX26_HDR_CONTRACTS);
   PRINT_MACRO(BOOST_NO_CXX26_HDR_DEBUGGING);
   PRINT_MACRO(BOOST_NO_CXX26_HDR_HAZARD_POINTER);
   PRINT_MACRO(BOOST_NO_CXX26_HDR_HIVE);
   PRINT_MACRO(BOOST_NO_CXX26_HDR_INPLACE_VECTOR);
   PRINT_MACRO(BOOST_NO_CXX26_HDR_LINALG);
   PRINT_MACRO(BOOST_NO_CXX26_HDR_RCU);
   PRINT_MACRO(BOOST_NO_CXX26_HDR_SIMD);
   PRINT_MACRO(BOOST_NO_CXX26_HDR_TEXT_ENCODING);
