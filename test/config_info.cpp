...
void print_boost_macros()
{
   ...
   PRINT_MACRO(BOOST_NO_CXX14_DEPRECATED_ATTRIBUTES);
   ...
   PRINT_MACRO(BOOST_NO_CXX14_MEMBER_INITIALIZERS_AND_AGGREGATES);
   PRINT_MACRO(BOOST_NO_CXX14_RELAXED_CONSTEXPR);
   PRINT_MACRO(BOOST_NO_CXX14_RETURN_TYPE_DEDUCTION);
   PRINT_MACRO(BOOST_NO_CXX14_SIZED_DEALLOCATION);
