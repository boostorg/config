...
int main( int, char *[] )
{
   ...
   if(0 != boost_no_cxx14_deprecated_attributes::test())
   {
      std::cerr << "Failed test for BOOST_NO_CXX14_DEPRECATED_ATTRIBUTES at: " << __FILE__ << ":" << __LINE__ << std::endl;
      ++error_count;
   }
   ...
   if(0 != boost_no_cxx14_sized_deallocation::test())
   {
      std::cerr << "Failed test for BOOST_NO_CXX14_SIZED_DEALLOCATION at: " << __FILE__ << ":" << __LINE__ << std::endl;
      ++error_count;
   }
   ...
   if(0 != boost_no_cxx14_relaxed_constexpr::test())
   {
      std::cerr << "Failed test for BOOST_NO_CXX14_RELAXED_CONSTEXPR at: " << __FILE__ << ":" << __LINE__ << std::endl;
      ++error_count;
   }
   ...
   if(0 != boost_no_cxx14_member_initializers_and_aggregates::test())
   {
      std::cerr << "Failed test for BOOST_NO_CXX14_MEMBER_INITIALIZERS_AND_AGGREGATES at: " << __FILE__ << ":" << __LINE__ << std::endl;
      ++error_count;
   }
